...
AUTHENTICATION_BACKENDS = [
    ...
    "omibus.users.auth_backend.PasswordlessAuthBackend",
]
...
ADMINS = [("""omibus""", "maferelo@outlook.com")]
...
# -------------------------------------------------------------------------------
# django-rest-framework - https://www.django-rest-framelwork.org/api-guide/settings/
REST_FRAMEWORK = {
